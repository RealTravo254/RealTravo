...
  // Location state remains removed
...
      // Adventure type now has no filters in this bar
    }
    
...
  return (
    <div className="bg-primary/10 p-2 md:p-4 rounded-lg space-y-2 md:space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-sm md:text-base">Filters</h3>
      </div>
      
      {/* The grid layout is now simplified to 2 columns on mobile, 3 on desktop, 
            as there are only 2 date inputs maximum. */}
...
        {/* --- Adventure Filters --- */}
        {type === "adventure" && (
          {/* Ensures the message spans the full width of the grid (2 columns) */}
          <div className="col-span-2 text-center text-muted-foreground py-2 text-sm">
            Use the main search bar for location filtering.
          </div>
        )}
      </div>
        
      {/* Apply/Clear Buttons (Moved outside the filter grid) */}
