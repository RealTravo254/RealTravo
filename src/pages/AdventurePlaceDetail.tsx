...
      <div className="relative w-full overflow-hidden mb-6 sm:mb-4">
        {/* BACK BUTTON OVERLAY */}
        <Button 
          variant="outline" 
          onClick={() => navigate(-1)} 
          className="absolute top-4 left-4 z-20 h-10 w-10 p-0 rounded-full bg-background/70 hover:bg-background"
        >
          <ArrowLeft className="h-5 w-5" />
        </Button>

        {/* IMAGE CAROUSEL (Full width on mobile, no border-radius) */}
...
                  loading="lazy" 
                  decoding="async" 
                  className="w-full h-64 md:h-[400px] object-cover" // Increased height on md screen for better view
                />
              </CarouselItem>
            ))}
          </CarouselContent>
...
        </Carousel>
        
        {/* Description Section - Kept on the image for effect, removed bottom radius */}
        {place.description && (
          <div 
...
      <main className="container px-4 py-0 sm:py-0 max-w-6xl mx-auto">
        
        {/* Content Grid starts here */}
        <div className="grid lg:grid-cols-[2fr,1fr] gap-6 sm:gap-4">
          {/* The main content column is implicitly here, covering the space previously used by the image */}
          
...
          {/* The second column (lg:grid-cols-[2fr,1fr] for desktop layout) is implicitly here */}
          
        </div>
