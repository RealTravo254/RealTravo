  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        ...
        // If user is not verified and has no company, show the Selection Cards (Matches image_19fd7a.png)
        if (!hasV && !company) {
        ...
        // Logic for verified hosts to fetch their actual data
        ...
        <main className="flex-1 container px-4 py-8 mx-auto mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <SelectionCard
              ...
              bg="bg-orange-50"
            />
            {/* NEW ADVENTURE CARD FOR UNVERIFIED USERS */}
            <SelectionCard
              icon={<Trees className="h-8 w-8 text-emerald-600" />}
              title="Adventure Place"
              desc="List your campsite, park, or private adventure destination. Verification required."
    ...
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col">
      ...
      <main className="flex-1 container px-4 py-12 mx-auto mb-24">
        ...
        <div className="grid grid-cols-1 gap-6">
          {/* Adventure Places Card shown on Dashboard for verified users */}
          ...
          {/* Add other dashboard cards (Trips, Events) here */}
        </div>
      </main>
      <MobileBottomBar />
    </div>
