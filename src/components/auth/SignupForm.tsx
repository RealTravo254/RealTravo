  ...
  return (
    <div className="space-y-4">
      ...
      <button type="button" onClick={handleGoogleSignUp} disabled={googleLoading}
        ...
        {googleLoading ? <Loader2 className="h-5 w-5 animate-spin text-white/70" /> : (
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-transparent px-3 text-white/40 font-medium">or sign up with email</span>
        </div>
      </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="dob" className={labelClass}>
            <span className="flex items-center gap-1.5">
              ...
              Date of Birth <span className="text-white/40 text-xs font-normal">(must be 18+)</span>
            </span>
          </Label>
          <Input
            id="dob"
