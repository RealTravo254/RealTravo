          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "**text-blue-600**" // Change active text color for better contrast on white background
                  : "**text-gray-500 hover:text-blue-600**" // Change inactive text color for better contrast on white background
              )}
            >
