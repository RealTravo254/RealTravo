        ...
        {user ? (
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 h-8 rounded-md flex items-center justify-center gap-1 text-[11px] font-black text-white transition-all active:scale-95"
              style={{ background: "linear-gradient(135deg,#008080 0%,#005f5f 100%)" }}
            >
              Sign Up
            </button>
            <button
              ...
              className="flex-1 h-8 rounded-md flex items-center justify-center gap-1 text-[11px] font-bold border border-border bg-background text-foreground hover:bg-muted transition-all active:scale-95"
            >
              Log In
            </button>
          </div>
